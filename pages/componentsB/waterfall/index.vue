<template>
	<view class="wrap">
		<zy-waterfall v-model="flowList" ref="uWaterfall">
			<template v-slot:left="{ leftList }">
				<view class="demo-warter" v-for="(item, index) in leftList" :key="index">
					...
					<zy-icon name="close-circle-fill" color="#fa3534" size="34" class="u-close" @click="remove(item.id)"></zy-icon>
				</view>
			</template>
...
.demo-tag-text {
	border: 1px solid $zy-type-primary;
	color: $zy-type-primary;
	margin-left: 10px;
	border-radius: 50rpx;
	line-height: 1;
	padding: 4rpx 14rpx;
