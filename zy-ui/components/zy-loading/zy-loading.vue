<template>
	<view v-if="show" class="zy-loading" :class="mode == 'circle' ? 'zy-loading-circle' : 'zy-loading-flower'" :style="[cricleStyle]">
	</view>
</template>
...
<style lang="scss" scoped>
    .zy-loading-circle{
        ...
        animation: zy-circle 1s linear infinite;
    }
    ...
    .zy-loading-flower {
		...
		animation: zy-flower 1s steps(12) infinite;
