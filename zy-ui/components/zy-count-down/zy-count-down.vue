<template>
	<view class="zy-countdown">
		<view class="zy-countdown-item" :style="[itemStyle]" v-if="showDays && (hideZeroDay || (!hideZeroDay && d != '0'))">
			<view class="zy-countdown-time" :style="[letterStyle]">
				{{ d }}
			</view>
		</view>
		<view
			class="zy-countdown-colon"
		...
		<view class="zy-countdown-item" :style="[itemStyle]" v-if="showHours">
			<view class="zy-countdown-time" :style="{ fontSize: fontSize + 'rpx', color: color}">
				{{ h }}
			</view>
		</view>
		<view
		...
		<view class="zy-countdown-item" :style="[itemStyle]" v-if="showMinutes">
			<view class="zy-countdown-time" :style="{ fontSize: fontSize + 'rpx', color: color}">
				{{ i }}
			</view>
		</view>
		...
		<view class="zy-countdown-item" :style="[itemStyle]" v-if="showSeconds">
			<view class="zy-countdown-time" :style="{ fontSize: fontSize + 'rpx', color: color}">
				{{ s }}
			</view>
		</view>
 ...
 * @example <zy-count-down ref="uCountDown" :timestamp="86400" :autoplay="false"></zy-count-down>
 */
export default {
	name: 'zy-count-down',
	props: {
